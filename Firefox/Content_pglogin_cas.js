setTimeout(() => {
     ...
     */
     function patchCSS(theme) {
        if(theme === "light"){
            ...
            link.href = browser.runtime.getURL("css/cas/light.css")
        }else if(theme === "dark"){
            // Dark Theme
            console.log("dark")
            localStorage.setItem("plus-theme", "dark")
            link.href = browser.runtime.getURL("css/cas/dark.css")
        }
    }
    ...
    themeSwitcher.innerHTML = "Changer de thème (CAS)";
    ...
    document.getElementsByClassName("navbar-expand-md")[0].removeAttribute("style");
    document.getElementsByClassName("navbar-collapse")[0].removeAttribute("style");
}, 50);