setTimeout(() => {
     ...
     */
     function patchCSS(theme) {
        if(theme === "light"){
            ...
            link.href = browser.runtime.getURL("css/mainloginpage/light_elyco_firstloginpage.css")
        }else if(theme === "dark"){
            // Dark Theme
            console.log("dark")
            localStorage.setItem("plus-theme", "dark")
            link.href = browser.runtime.getURL("css/mainloginpage/dark_elyco_firstloginpage.css")
        }
    }
    ...
    themeSwitcher.innerHTML = "Changer de thème (Page de connexion E-lyco)";
